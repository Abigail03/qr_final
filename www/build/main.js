...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__guardados_guardados__ = __webpack_require__(415);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__home_home__ = __webpack_require__(417);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tabs_tabs__ = __webpack_require__(418);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_scan_data_model__ = __webpack_require__(416);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_email_composer__ = __webpack_require__(266);
...
var HistorialService = /** @class */ (function () {
    function HistorialService(iab, modalCtrl, contacts, platform, toastCtrl, emailComposer) {
        this.iab = iab;
    ...
    HistorialService.prototype.send = function (texto) {
        var direccion = texto.split(";");
...
var MapaPage = /** @class */ (function () {
    ...
    MapaPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-mapa',template:/*ion-inline-start:"/Users/Abigail/Desktop/ios_android_final/src/pages/mapa/mapa.html"*/'<ion-content>\n\n\n  <agm-map [latitude]="lat" [longitude]="lng" [zoom]="16">\n    <agm-marker [latitude]="lat" [longitude]="lng"></agm-marker>\n  </agm-map>\n\n\n</ion-content>\n\n\n \n<ion-footer>\n\n  <ion-toolbar color="primary">\n\n    <ion-buttons end>\n      <button ion-button\n              (click)="cerrar_modal()">\n        Cerrar\n      </button>\n    </ion-buttons>\n\n  </ion-toolbar>\n\n</ion-footer> \n'/*ion-inline-end:"/Users/Abigail/Desktop/ios_android_final/src/pages/mapa/mapa.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_component__ = __webpack_require__(409);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__agm_core__ = __webpack_require__(419);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_barcode_scanner__ = __webpack_require__(267);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_email_composer__ = __webpack_require__(266);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/Abigail/Desktop/ios_android_final/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/Abigail/Desktop/ios_android_final/src/app/app.html"*/
        }),
...
var GuardadosPage = /** @class */ (function () {
    ...
    GuardadosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-guardados',template:/*ion-inline-start:"/Users/Abigail/Desktop/ios_android_final/src/pages/guardados/guardados.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title> Historial </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n  <ion-list>\n\n    <button ion-item\n            *ngFor="let data of historial; let i = index"\n            (click)="abrir_scan( i )">\n      {{ data.info }}\n      <p>\n        {{ data.tipo }}\n      </p>\n    </button>\n\n  </ion-list>\n\n\n</ion-content>\n'/*ion-inline-end:"/Users/Abigail/Desktop/ios_android_final/src/pages/guardados/guardados.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_barcode_scanner__ = __webpack_require__(267);
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.scan = function () {
        ...
        if (!this.platform.is('cordova')) {
            ...
            this._historialService.agregar_historial("geo:24.044990,-104.640098");
            this._historialService.agregar_historial("BEGIN:VCARD\nVERSION:2.1\nN:Kent;Clark\nFN:Clark Kent\nORG:\nTEL;HOME;VOICE:12345\nTEL;TYPE=cell:67890\nADR;TYPE=work:;;;\nEMAIL:clark@superman.com\nEND:VCARD");
            this._historialService.agregar_historial("MATMSG:TO:abigail.orti@gmail.com;SUB:Generador QR;BODY:El correo ha sido enviado desde aplicación QRAPP;;");
        }
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/Abigail/Desktop/ios_android_final/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>\n      QR-APP\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n\n  <button ion-button\n          block\n          (click)="scan()">\n    Realizar Scan\n  </button>\n\n\n\n</ion-content>\n'/*ion-inline-end:"/Users/Abigail/Desktop/ios_android_final/src/pages/home/home.html"*/
        }),
...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-tabs',template:/*ion-inline-start:"/Users/Abigail/Desktop/ios_android_final/src/pages/tabs/tabs.html"*/'\n\n<ion-tabs color="primary">\n\n  <ion-tab tabTitle="Scan" tabIcon="qr-scanner" [root]="tab1"></ion-tab>\n  <ion-tab tabTitle="Historial" tabIcon="list" [root]="tab2"></ion-tab>\n\n\n</ion-tabs>\n'/*ion-inline-end:"/Users/Abigail/Desktop/ios_android_final/src/pages/tabs/tabs.html"*/
        }),
